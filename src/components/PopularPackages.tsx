...
const packages = [
  {
    ...
    rating: 4.9,
    reviews: 124,
    image: "https://images.unsplash.com/photo-1586523969471-9b68408a9a9a?auto=format&fit=crop&w=800&q=80",
...
const PopularPackages = () => {
  ...
  return (
    <section ref={containerRef} className="py-24 relative overflow-hidden">
      {/* Top Gradient Fade - seamless transition */}
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-background/97 via-background/95 to-background/97" />
      </motion.div>
