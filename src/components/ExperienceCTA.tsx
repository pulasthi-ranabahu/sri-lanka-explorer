...
const ExperienceCTA = () => {
  return (
    ...
    >
      {/* CSS Parallax Fixed Background - Leopard Close-up */}
      <div
        className="absolute inset-0 w-full h-full"
        style={{
          backgroundImage: `url('https://images.pexels.com/photos/39857/leopard-leopard-spots-animal-wild-39857.jpeg?auto=compress&cs=tinysrgb&w=1920')`,
